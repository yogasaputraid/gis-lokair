...
<script type="text/javascript">
	...
	var map = L.map('map').setView([-6.25788, 106.98046], 13);
	...
	var Layer = L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
		...
		accessToken: 'pk.eyJ1IjoieW9nYXNhcHV0cmEiLCJhIjoiY2w1Z3ZsNTg4MDNrYjNpbDJiZzB0MXMwbiJ9.5-Y1TBUidWasnMDJ_XReOw'
	});
